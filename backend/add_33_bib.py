...
sources = [
    ...
    # DOIs 2021
    "Кузьмин, В. Н., Менисов, А. Б. Методический подход к выявлению угрозы извлечения конфиденциальных данных из автоматизированных систем управления на базе интернет-технологий // Бизнес-информатика. – 2021. – Т. 15, № 3. – С. 35-47. – DOI: 10.17323/2587-814X.2021.3.35.47.",
    "Тельнов, Ю. Ф. [и др.]. Технология проектирования инновационных процессов создания продукции и услуг сетевого предприятия с использованием I4.0-системы, основанной на знаниях // Бизнес-информатика. – 2021. – Т. 15, № 4. – С. 76-92. – DOI: 10.17323/2587-814X.2021.4.76.92.",
    # ISBN Book
    ...
    "Официальная документация веб-сервера NGINX [Электронный ресурс]. – URL: https://nginx.org/en/docs/ (дата обращения: 25.05.2024).",
    "Официальная документация платформы Docker [Электронный ресурс]. – URL: https://docs.docker.com/ (дата обращения: 26.05.2024).",
    "Официальная документация библиотеки состояния Redux [Электронный ресурс]. – URL: https://redux.js.org/ (дата обращения: 27.05.2024).",
    "Официальная документация среды выполнения Node.js [Электронный ресурс]. – URL: https://nodejs.org/en/docs/ (дата обращения: 28.05.2024).",
    "Спецификация JSON Web Signature (JWS) - RFC 7515 [Электронный ресурс] // IETF Datatracker. – URL: https://datatracker.ietf.org/doc/html/rfc7515 (дата обращения: 29.05.2024).",
    "ГОСТ Р 53647.1-2009. Менеджмент непрерывности бизнеса. Часть 1. Практическое руководство [Электронный ресурс] // Электронный фонд правовых и нормативно-технических документов. – URL: https://docs.cntd.ru/document/1200079361 (дата обращения: 30.05.2024).",
    "Официальная документация сервера Uvicorn (ASGI) [Электронный ресурс]. – URL: https://www.uvicorn.org/ (дата обращения: 30.05.2024).",
    "Официальная документация инструмента сборки Vite [Электронный ресурс]. – URL: https://vitejs.dev/guide/ (дата обращения: 30.05.2024)."
]
...
print("Bibliography replaced with exactly 33 verified sources.")
