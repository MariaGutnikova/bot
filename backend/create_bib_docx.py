...
# Add a title
title = doc.add_paragraph("СПИСОК ИСПОЛЬЗОВАННОЙ ЛИТЕРАТУРЫ")
...
for idx, source_text in enumerate(sources):
    ...
    new_p = doc.add_paragraph(full_text)
...
doc.save('../Список_литературы.docx')
print("Список_литературы.docx created successfully with 32 items.")
