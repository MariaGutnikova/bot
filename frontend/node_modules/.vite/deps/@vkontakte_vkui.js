...
function DevelopmentCheck({ children }) {
  const { size: size5 } = React28.useContext(ImageBaseContext);
  if (children) {
...
function useIsClient(initial = false) {
  const [isClient2, setIsClient] = React29.useState(initial);
  useIsomorphicLayoutEffect(() => {
    setIsClient(true);
  }, []);
  return isClient2;
...
function DevelopmentCheck2({ children }) {
  const { size: size5 } = React33.useContext(ImageBaseContext);
  if (true) {
    if (children) {
...
var Spinner = React37.memo((_param) => {
  var { size: size5 = "regular", children = "Загружается...", disableAnimation = false, noColor = false } = _param, restProps = _object_without_properties(_param, [
    "size",
    "children",
    "disableAnimation",
    "noColor"
...
var Button = (_param) => {
  var { size: size5 = "s", mode = "primary", appearance = "accent", stretched = false, align = "center", children, before, after, getRootRef, loading, onClick, className, disableSpinnerAnimation, rounded } = _param, restProps = _object_without_properties(_param, [
    "size",
    "mode",
    "appearance",
    "stretched",
...
function rubber(offset5, dimension, resistanceRate, isAndroid) {
  if (isAndroid || offset5 < 0) {
    return offset5;
  }
  const offsettedResistance = offset5 * resistanceRate;
...
var index = isClient ? import_react7.useLayoutEffect : noop2;
...
var autoPlacement3 = function autoPlacement4(options, deps) {
  var result = autoPlacement2(options);
  return {
    name: result.name,
    fn: result.fn,
    options: [
...
var useFloatingMiddlewaresBootstrap = ({ placement = "bottom-start", arrowRef = null, arrow: arrow5, arrowHeight, arrowPadding, sameWidth, offsetByMainAxis = 0, offsetByCrossAxis = 0, customMiddlewares, hideWhenReferenceHidden, disableFlipMiddleware = false }) => {
...
var Spacing = (_param) => {
  var { size: size5 = "m", style } = _param, restProps = _object_without_properties(_param, [
    "size",
    "style"
  ]);
  return (0, import_jsx_runtime39.jsx)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    style: _object_spread({}, typeof size5 === "number" && {
      [CUSTOM_CSS_TOKEN_FOR_USER_GAP]: `${size5}px`
    }, style),
    baseClassName: clsx("vkuiSpacing", typeof size5 === "string" && sizesClassNames[size5])
  }));
};
...
var ScrollArrow = (_param) => {
  var { size: size5 = "l", offsetY, direction, label: labelProp, children = (0, import_jsx_runtime53.jsx)(ArrowIcon, {
    size: size5
  }) } = _param, restProps = _object_without_properties(_param, [
    "size",
    "offsetY",
  ...
  return (0, import_jsx_runtime53.jsxs)(RootComponent, _object_spread_props(_object_spread({
    Component: "button",
    type: "button",
    baseClassName: clsx("vkuiScrollArrow", stylesSize2[size5], stylesDirection2[direction])
  }, restProps), {
    children: [
...
var FloatingArrow = (_param) => {
  var { offset: offset5, isStaticOffset, coords, iconStyle, iconClassName, placement = "bottom", getRootRef, Icon = DefaultIcon } = _param, restProps = _object_without_properties(_param, [
    "offset",
    "isStaticOffset",
    "coords",
    "iconStyle",
...
var Popper = (_param) => {
  ...
  const dropdown = (0, import_jsx_runtime71.jsxs)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    ...
    children: [
      arrow5 && (0, import_jsx_runtime71.jsx)(FloatingArrow, _object_spread_props(_object_spread({}, arrowProps), {
        coords: arrowCoords,
...
var ScreenSpinnerLoader = (_param) => {
  var { size: size5 = "large", children } = _param, restProps = _object_without_properties(_param, [
    "size",
    "children"
  ]);
...
var ModalPage = (_param) => {
  ...
  const size5 = isDesktop ? sizeProp : "s";
  ...
  return (0, import_jsx_runtime92.jsx)(ModalPageContext.Provider, {
    ...
    children: (0, import_jsx_runtime92.jsx)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
      ...
      id,
      baseClassName: clsx("vkuiModalPage", platform3 === "ios" && "vkuiModalPage--ios", isDesktop && "vkuiModalPage--desktop", sizeX === "regular" && "vkuiInternalModalPage--sizeX-regular", typeof size5 === "string" && sizeClassName[size5]),
      children: (0, import_jsx_runtime92.jsx)("div", {
        className: "vkuiModalPage__in-wrap",
        style: {
          maxWidth: typeof size5 === "number" ? size5 : void 0,
          height
        },
...
var ModalCard = (_param) => {
  var { icon, header, headerComponent, subheader, subheaderComponent, children, actions, onClose, nav, id, size: size5, modalDismissButtonTestId, getRootRef, dismissButtonMode, dismissLabel } = _param, restProps = _object_without_properties(_param, [
    "icon",
    "header",
    "headerComponent",
    "subheader",
...
var ContentBadgeSlotIcon = (_param) => {
  ...
  const { size: size5, isSingleChild } = React121.useContext(ContentBadgeContext);
  if (size5 === "s") {
    return null;
  }
...
var ContentBadge = (_param) => {
  var { appearance = "accent", mode = "primary", capsule, size: size5 = "m", weight = "2", className, children } = _param, restProps = _object_without_properties(_param, [
    "appearance",
    "mode",
    "capsule",
    "size",
  ...
  const TypographyComponent = size5 === "l" ? Footnote : Caption;
  return (0, import_jsx_runtime99.jsx)(TypographyComponent, _object_spread_props(_object_spread({}, restProps), {
    weight,
    normalize: true,
    className: clsx(className, "vkuiContentBadge", size5 !== "s" && capsule && "vkuiContentBadge--capsule", mode === "outline" && "vkuiContentBadge--mode-outline", appearanceClassNames[appearance][mode], sizeClassNames[size5]),
...
var CardGrid = (_param) => {
  ...
  return (0, import_jsx_runtime102.jsx)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    Component: Component3,
    baseClassName: clsx("vkuiCardGrid", "vkuiInternalCardGrid", spaced && "vkuiCardGrid--spaced", stylesSize3[size5], sizeX !== "regular" && sizeXClassNames5[sizeX])
  }));
};
...
var CardScroll = (_param) => {
  ...
  function getScrollToLeft(offset5) {
    ...
    ].findIndex((el) => el.offsetLeft + el.offsetWidth + parseInt(window2.getComputedStyle(el).marginRight) - offset5 >= 0);
    if (slideIndex === -1) {
      return offset5;
    }
    if (slideIndex === 0) {
  ...
  function getScrollToRight(offset5) {
    ...
    const containerWidth = refContainer.current.offsetWidth;
    const slide = Array.prototype.find.call(refContainer.current.children, (el) => el.offsetLeft + el.offsetWidth - offset5 > containerWidth);
    if (!slide) {
      return offset5;
    }
  ...
  return (0, import_jsx_runtime103.jsx)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    Component: Component3,
    baseClassName: clsx("vkuiCardScroll", "vkuiInternalCardScroll", size5 !== false && stylesSize4[size5], !noSpaces && "vkuiCardScroll--withSpaces"),
...
var HeaderContent = (_param) => {
  var { mode, size: size5 } = _param, restProps = _object_without_properties(_param, [
    "mode",
    "size"
  ]);
  const isLarge = size5 === "large";
  const platform3 = usePlatform();
  if (platform3 === "ios") {
    switch (mode) {
      case "primary":
...
var Header = (_param) => {
  var { mode = "primary", size: size5 = "regular", Component: Component3 = "h2", children, subtitle, subtitleComponent = "span", indicator, aside, multiline, before, beforeTitle, afterTitle, beforeSubtitle, afterSubtitle } = _param, restProps = _object_without_properties(_param, [
    "mode",
    "size",
    "Component",
    "children",
  ...
  return (0, import_jsx_runtime105.jsxs)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    baseClassName: clsx("vkuiHeader", stylesMode6[mode], size5 === "large" && "vkuiHeader--large", isPrimitiveReactNode(indicator) && "vkuiHeader--pi", hasReactNode(subtitle) && "vkuiHeader--with-subtitle"),
    children: [
...
var AvatarBadge = (_param) => {
  ...
  const { size: size5 } = React139.useContext(ImageBaseContext);
  return (0, import_jsx_runtime122.jsx)(ImageBase.Badge, _object_spread_props(_object_spread({}, restProps), {
    className: clsx("vkuiAvatarBadge", size5 < 96 && "vkuiAvatarBadge--shifted", className)
  }));
};
...
var AvatarBadgeWithPreset = (_param) => {
  ...
  const { size: size5 } = React141.useContext(ImageBaseContext);
...
var CellTypography = (_param) => {
  var { size: size5, children } = _param, restProps = _object_without_properties(_param, [
    "size",
    "children"
  ]);
  return size5 === "s" ? (0, import_jsx_runtime126.jsx)(Caption, _object_spread_props(_object_spread({}, restProps), {
    children
...
var HorizontalCell = (_param) => {
  var { className, header, style, subtitle, size: size5 = "s", children = (0, import_jsx_runtime126.jsx)(Avatar, {
    size: 56
  ...
  return (0, import_jsx_runtime126.jsx)("div", {
    ref: getRootRef,
    style,
    className: clsx("vkuiHorizontalCell", stylesSize5[size5], className),
...
var HorizontalCellShowMore = (_param) => {
  var { className, style, getRef, getRootRef, compensateLastCellIndent, height, size: size5 = "s", children = size5 === "s" ? "Все" : "Показать все", centered = false } = _param, restProps = _object_without_properties(_param, [
    "className",
    "style",
    "getRef",
    "getRootRef",
  ...
  return (0, import_jsx_runtime127.jsx)("div", {
    style,
    className: clsx("vkuiHorizontalCellShowMore", compensateLastCellIndent && "vkuiHorizontalCellShowMore--compensate-last-cell-indent", centered && "vkuiHorizontalCellShowMore--centered", sizeClassNames2[size5], className),
    ref: getRootRef,
...
var BaseGallery = (_param) => {
  ...
  const getTarget = (e) => {
    ...
    var _layoutState_current_max;
    const shift5 = shiftState.shiftX + shiftState.deltaX + expectDeltaX - ((_layoutState_current_max = layoutState.current.max) !== null && _layoutState_current_max !== void 0 ? _layoutState_current_max : 0);
    const direction = shiftState.deltaX < 0 ? 1 : -1;
    let targetIndex = layoutState.current.slides.reduce((val, item, index2) => {
      const previousValue = Math.abs(layoutState.current.slides[val].coordX + shift5);
      const currentValue = Math.abs(item.coordX + shift5);
...
function calculateLoopPoints(indexes, edge, slidesManager, containerWidth) {
  ...
  return indexes.map((index2) => {
    ...
    const loopPoint = isStartEdge ? snaps[index2] + containerWidth + offset5 : snaps[index2] - slides[index2].width + offset5 - snaps[0];
    return {
      index: index2,
...
function getTargetIndex(slides, slideIndex, currentShiftX, currentShiftXDelta) {
  const shift5 = currentShiftX + currentShiftXDelta;
  const direction = currentShiftXDelta < 0 ? 1 : -1;
  let targetIndex = slides.reduce((val, item, index2) => {
    const previousValue = Math.abs(slides[val].coordX + shift5);
    const currentValue = Math.abs(item.coordX + shift5);
    return previousValue < currentValue ? val : index2;
  }, slideIndex);
  if (targetIndex === slideIndex) {
...
var GridAvatarBadge = (_param) => {
  ...
  const { size: size5 } = React150.useContext(ImageBaseContext);
  return (0, import_jsx_runtime133.jsx)(ImageBase.Badge, _object_spread_props(_object_spread({}, restProps), {
    className: clsx("vkuiGridAvatarBadge", size5 < 96 && "vkuiGridAvatarBadge--shifted", className)
  }));
};
...
var ImageBadge = (_param) => {
  ...
  const { size: size5 } = React151.useContext(ImageBaseContext);
  return (0, import_jsx_runtime135.jsx)(ImageBase.Badge, _object_spread_props(_object_spread({}, restProps), {
    className: clsx("vkuiImageBadge", size5 < 96 && "vkuiImageBadge--shifted", className)
  }));
};
    ...
    switch (key) {
      ...
      case "Home": {
        ...
        if (key === "Home") {
          ...
          const offset5 = key === "ArrowRight" ? 1 : -1;
...
var Counter = (_param) => {
  var { mode = "inherit", size: size5 = "m", children, className } = _param, restProps = _object_without_properties(_param, [
    "mode",
    "size",
    "children",
    "className"
  ...
  return (0, import_jsx_runtime146.jsx)(CounterTypography, _object_spread_props(_object_spread({}, restProps), {
    Component: "span",
    className: clsx("vkuiInternalCounter", "vkuiCounter", modeClassNames3[mode], sizeClassNames3[size5], className),
    level: counterLevel,
    children
  }));
};
...
var UsersStack = (_param) => {
  var { photos = [], visibleCount = 3, count = Math.max(0, photos.length - visibleCount), size: size5 = "m", children, direction = "row" } = _param, restProps = _object_without_properties(_param, [
    "photos",
    "visibleCount",
    "count",
    "size",
  ...
  return (0, import_jsx_runtime147.jsxs)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    baseClassName: clsx("vkuiUsersStack", stylesSize6[size5], stylesDirection4[direction]),
    children: [
...
var Banner = (_param) => {
  var { mode = "tint", imageTheme = "dark", size: size5 = "s", before, asideMode, header, subheader, text, children, background, actions, onDismiss, dismissLabel = "Скрыть" } = _param, restProps = _object_without_properties(_param, [
    "mode",
    "imageTheme",
    "size",
    "before",
  ...
  const SubheaderTypography = size5 === "m" ? Text : Subhead;
  ...
  return (0, import_jsx_runtime149.jsx)(RootComponent, _object_spread_props(_object_spread({
    ...
    baseClassName: clsx("vkuiBanner", platform3 === "ios" && "vkuiBanner--ios", mode === "image" && "vkuiBanner--mode-image", size5 === "m" && "vkuiBanner--size-m", mode === "image" && imageTheme === "dark" && "vkuiBanner--inverted"),
...
var SubnavigationButton = (_param) => {
  var { mode = "primary", appearance = "accent", size: size5 = "m", selected, textLevel = "1", before, after, expandable, children, className } = _param, restProps = _object_without_properties(_param, [
    "mode",
    "appearance",
    "size",
    "selected",
  ...
  return (0, import_jsx_runtime154.jsx)(Tappable, _object_spread_props(_object_spread({}, restProps), {
    hasActive: false,
    focusVisibleMode: "outside",
    className: clsx("vkuiSubnavigationButton", sizeStyles[size5], modeStyles2[mode], appearanceStyles[appearance], selected && "vkuiSubnavigationButton--selected", sizeY !== "regular" && sizeYClassNames18[sizeY], className),
...
var File = (_param) => {
  var { children = "Выберите файл", align = "left", size: size5, mode, stretched, before, after, loading, className, style, getRef, getRootRef, appearance } = _param, restProps = _object_without_properties(_param, [
    "children",
    "align",
    "size",
    "mode",
...
var Slider = (_param) => {
  var { step = 1, min: min3 = 0, max: max3 = 100, value: valueProp, multiple: multipleProp, defaultValue = multipleProp ? [
    min3,
    max3
  ] : min3, disabled, className, getRootRef, getAriaLabel, getAriaValueText, onChange, withTooltip, size: size5 = "l" } = _param, restProps = _object_without_properties(_param, [
    "step",
    "min",
    "max",
    "value",
  ...
  return (0, import_jsx_runtime188.jsxs)(Touch, _object_spread_props(_object_spread({
    ...
    className: clsx("vkuiSlider", disabled && "vkuiSlider--disabled", sizeY !== "regular" && sizeYClassNames27[sizeY], sizeClassNames4[size5], className),
...
var SegmentedControl = (_param) => {
  var { size: size5 = "l", name, options, defaultValue = (_options_ = options[0]) === null || _options_ === void 0 ? void 0 : _options_.value, children, onChange: onChangeProp, value: valueProp } = _param, restProps = _object_without_properties(_param, [
    "size",
    "name",
    "options",
    "defaultValue",
  ...
  return (0, import_jsx_runtime207.jsx)(RootComponent, _object_spread_props(_object_spread({}, restProps), {
    baseClassName: clsx("vkuiSegmentedControl", sizeY !== "compact" && sizeYClassNames36[sizeY], size5 === "l" && "vkuiSegmentedControl--size-l"),
...
var CalendarDay = React229.memo((_param) => {
  var { day, today, selected, onChange, hidden, disabled, active, selectionStart, selectionEnd, focused, onEnter, onLeave, hinted, hintedSelectionStart, hintedSelectionEnd, sameMonth, size: size5, className, children, renderDayContent, testId } = _param, restProps = _object_without_properties(_param, [
    "day",
    "today",
    "selected",
    "onChange",
...
var CalendarDays = (_param) => {
  var { viewDate, value, weekStartsOn, onDayChange, isDaySelected, isDayActive, isDaySelectionEnd, isDaySelectionStart, onDayEnter, onDayLeave, isDayHinted, isHintedDaySelectionStart, isHintedDaySelectionEnd, isDayFocused, isDayDisabled, size: size5, showNeighboringMonth = false, dayProps, listenDayChangesForUpdate = false, getRootRef, renderDayContent, dayTestId } = _param, props = _object_without_properties(_param, [
    "viewDate",
    "value",
    "weekStartsOn",
    "onDayChange",
  ...
  return (0, import_jsx_runtime209.jsxs)(RootComponent, _object_spread_props(_object_spread({}, props), {
    ...
    children: [
      (0, import_jsx_runtime209.jsx)("div", {
        className: clsx("vkuiCalendarDays__row", size5 === "s" && "vkuiCalendarDays__row--size-s"),
...
var Calendar = (_param) => {
  var { value, onChange, disablePast, disableFuture, shouldDisableDate, onClose, enableTime = false, doneButtonText, doneButtonDisabled, doneButtonShow, weekStartsOn = 1, disablePickers, changeHoursLabel = "Изменить час", changeMinutesLabel = "Изменить минуту", prevMonthLabel = "Предыдущий месяц", nextMonthLabel = "Следующий месяц", changeMonthLabel = "Изменить месяц", changeYearLabel = "Изменить год", showNeighboringMonth, changeDayLabel = "Изменить день", size: size5 = "m", viewDate: externalViewDate, onHeaderChange, onNextMonth, onPrevMonth, prevMonthIcon, nextMonthIcon, prevMonthProps, nextMonthProps, dayProps, listenDayChangesForUpdate, renderDayContent, minDateTime, maxDateTime, minutesTestId, hoursTestId, doneButtonTestId, prevMonthButtonTestId, nextMonthButtonTestId, monthDropdownTestId, yearDropdownTestId, dayTestId } = _param, props = _object_without_properties(_param, [
    "value",
    "onChange",
    "disablePast",
    "disableFuture",
  ...
  return (0, import_jsx_runtime213.jsxs)(RootComponent, _object_spread_props(_object_spread({}, props), {
    baseClassName: clsx("vkuiCalendar", size5 === "s" && "vkuiCalendar--size-s"),
    children: [
      ...
      enableTime && value && size5 !== "s" && (0, import_jsx_runtime213.jsx)("div", {
...
var DateInput = (_param) => {
  var { enableTime, shouldDisableDate, disableFuture, disablePast, minDateTime, maxDateTime, value, onChange, calendarPlacement = "bottom-start", style, className, doneButtonText, closeOnChange = true, disablePickers, getRootRef, name, autoFocus, disabled, onClick, onFocus, prevMonthLabel = "Предыдущий месяц", nextMonthLabel = "Следующий месяц", showNeighboringMonth, size: size5, changeMonthLabel = "Изменить месяц", changeYearLabel = "Изменить год", changeDayLabel = "Изменить день", changeHoursLabel = "Изменить час", changeMinutesLabel = "Изменить минуту", clearFieldLabel = "Очистить поле", showCalendarLabel = "Показать календарь", viewDate, onHeaderChange, onNextMonth, onPrevMonth, prevMonthIcon, nextMonthIcon, disableCalendar = false, renderDayContent, onCalendarOpenChanged, calendarTestsProps, dayFieldTestId, monthFieldTestId, yearFieldTestId, hourFieldTestId, minuteFieldTestId } = _param, props = _object_without_properties(_param, [
    "enableTime",
    "shouldDisableDate",
    "disableFuture",
    "disablePast",
...
var Popover = (_param) => {
  ...
  if (shown || keepMounted) {
    ...
    if (withArrow) {
      const { arrow: arrowCoords } = middlewareData;
      arrow5 = (0, import_jsx_runtime229.jsx)(FloatingArrow, _object_spread_props(_object_spread({
